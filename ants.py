...
class Ant(Insect):
    ...
    def can_contain(self, other):
        if self.container is True and self.ant is None and other.container != True:
            return True
        else:
            return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while random_or_none(place.bees) == None or i < self.min_range:
            place = place.entrance
            i += 1
            if place == hive or i > self.max_range:
                return None
        ...
        if self.imposter:
            ...
            while place != None:
                if place.ant == None:
                    ...
                    if place.ant.container and place.ant not in self.doubled:
                        double_damage(place.ant)
                        if place.ant.ant != None and place.ant.ant not in self.doubled:
                            double_damage(place.ant.ant)
                        place = place.exit
                    elif place.ant.container and place.ant in self.doubled and place.ant.ant != None:
                        if place.ant.ant not in self.doubled:
                            double_damage(place.ant.ant)
                        place = place.exit
                    elif place.ant in self.doubled:
                        place = place.exit
                    else:
                        double_damage(place.ant)
                        place = place.exit
